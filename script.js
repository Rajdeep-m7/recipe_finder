...
mealsContainer.addEventListener("click",handleMeals);
...
async function searchMeals() {
    ...
    if(!searchItem){
        errorContainer.textContent="please enter a search item";
    ...
    try{
        ...
        if(data.meals==null){
            ...
            errorContainer.textContent=`invalid search item "${searchItem}, try another items"`;
            errorContainer.classList.remove("hidden");
